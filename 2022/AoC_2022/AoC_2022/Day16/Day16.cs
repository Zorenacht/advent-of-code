...
public sealed partial class Day16 : Day
{
    ...
    [Test]
    public void ExampleP2() => CaveValves.Parse(InputExample).Reduce().MaxWithElephant(26).Should().Be(1751);
    [Test]
    public void Part2() => CaveValves.Parse(InputPart1).Reduce().MaxWithElephant(26).Should().Be(0);
}

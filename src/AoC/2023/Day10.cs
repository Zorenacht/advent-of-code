...
public sealed class Day10 : Day
{
    ...
    private class Loop
    {
        ...
        private Direction StartDirection(Grid<char> board, Index2D start)
        {
            IndexDirection[] nb =
            [
                new IndexDirection(start.Nb(Direction.W), Direction.E),
                new IndexDirection(start.Nb(Direction.N), Direction.S),
                new IndexDirection(start.Nb(Direction.E), Direction.W),
                new IndexDirection(start.Nb(Direction.S), Direction.N)
            ];
        ...
        {
            var iterator = new IndexDirection(start.Nb(direction), direction.Backwards());
        ...
        private static IEnumerable<IndexDirection> Mapping(char ch, IndexDirection indexDir)
        {
            ...
            {
                ('|', Direction.S) => [new IndexDirection(indexDir.Index.Nb(Direction.N), Direction.S)],
                ('|', Direction.N) => [new IndexDirection(indexDir.Index.Nb(Direction.S), Direction.N)],
                ('-', Direction.W) => [new IndexDirection(indexDir.Index.Nb(Direction.E), Direction.W)],
                ('-', Direction.E) => [new IndexDirection(indexDir.Index.Nb(Direction.W), Direction.E)],
                ('L', Direction.N) => [new IndexDirection(indexDir.Index.Nb(Direction.E), Direction.W)],
                ('L', Direction.E) => [new IndexDirection(indexDir.Index.Nb(Direction.N), Direction.S)],
                ('J', Direction.N) => [new IndexDirection(indexDir.Index.Nb(Direction.W), Direction.E)],
                ('J', Direction.W) => [new IndexDirection(indexDir.Index.Nb(Direction.N), Direction.S)],
                ('7', Direction.S) => [new IndexDirection(indexDir.Index.Nb(Direction.W), Direction.E)],
                ('7', Direction.W) => [new IndexDirection(indexDir.Index.Nb(Direction.S), Direction.N)],
                ('F', Direction.S) => [new IndexDirection(indexDir.Index.Nb(Direction.E), Direction.W)],
                ('F', Direction.E) => [new IndexDirection(indexDir.Index.Nb(Direction.S), Direction.N)],
                ('S', _) =>
                [
                    new IndexDirection(indexDir.Index.Nb(Direction.W), Direction.E),
                    new IndexDirection(indexDir.Index.Nb(Direction.N), Direction.S),
                    new IndexDirection(indexDir.Index.Nb(Direction.E), Direction.W),
                    new IndexDirection(indexDir.Index.Nb(Direction.S), Direction.N)
                ],
                _ => []
            };
        }
